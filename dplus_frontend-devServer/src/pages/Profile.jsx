...
export default function ProfilePage() {
  ...
  const handleSave = () => {
    ...
    const existingUser = safeParse(localStorage.getItem("user"), {});
    const [firstname, ...restNames] = updatedProfile.fullName.split(" ").filter(Boolean);
    const updatedUser = {
      ...existingUser,
      username: updatedProfile.username,
      firstname: firstname || updatedProfile.username,
    ...
    window.dispatchEvent(new CustomEvent("dy2-profile-updated", { detail: updatedProfile }));
  ...
  const avatarFallback = `https://ui-avatars.com/api/?name=${encodeURIComponent(
    profile.fullName || profile.username || "Datayog User"
  )}&background=F26522&color=fff&size=200`;
          ...
          <div className="grid gap-4 md:grid-cols-2">
              <label className="block">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none transition-all placeholder:text-white/25 focus:border-[#F26522]/45 focus:bg-white/7"
              ...
              <label className="block">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-white/35 transition hover:text-[#F26522]"
