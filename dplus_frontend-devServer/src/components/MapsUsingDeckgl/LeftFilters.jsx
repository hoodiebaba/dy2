...
return (
  <div className="relative">
    <button
      ...
      className="inline-flex h-[50px] items-center rounded-lg border border-[#d5dce9] bg-white/95 px-4 text-sm text-[#24314d] shadow-[0_12px_30px_rgba(15,23,42,0.14)] transition hover:bg-white"
    >
      Filters ☰
    </button>
